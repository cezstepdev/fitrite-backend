...
import com.fitrite.api.security.email.EmailSender;
...
import com.fitrite.api.security.user.UserRole;
import com.fitrite.api.security.user.UserService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String endpoint = "/api/fitrite/registration/confirm?token=" + token;
        link += endpoint;
    ...
    public String confirmToken(String token) {
        ...
        User user = userService.loadUserByUsername(confirmationToken.getUser().getEmail());
